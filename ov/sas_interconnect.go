...
type SasInterconnects struct {
	...
	InterconnectLocation      []InterconnectLocation  `json:"interconnectLocation"`                // "interconnectLocation": []
...
type InterconnectLocation struct {
	LocationEntries []LocationEntries `json:"locationEntries"` // "locationEntries": []
}

type LocationEntries struct {
	Type  string `json:"type,omitemtpy"`  // "type": "bay"
	Value string `json:"value,omitempty"` // "value": "4"
}
